    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        if gap_ranges:
            ...
            if use_lens:
                ...
                # eff_wide   = fin thickness at center height (widest point), default = full slab
                # eff_narrow = fin thickness at extremes (tapered ends),     default = 0 (taper to nothing)
                ...
                for h in hs:
                    ...
                    # t=0 at center → fin_t=eff_wide (wide fin); t=1 at extremes → fin_t=eff_narrow (tapered)
